...
app.get('/Usuarios', async (req, res) => {
  const [rows] = await pool.query(`SELECT Usuario, Contraseña as Contrasena, NombreCompleto, CorreoElectronico, FechaRegistro, IFNULL(UltimoInicioSesion,'2000-01-01 00:00:00') as UltimoInicioSesion, Rol, Estatus, CodigoVendedor, FechaNacimiento, Direccion, NumeroTelefono, Cedula FROM Usuarios`)
  res.json(rows)
})
